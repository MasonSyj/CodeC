...
#define CARSIZE 26
#define A 'A'
#define STRSIZE 401 // considering carpark can be 20x20
...
// small functions are tested in test()
void test();
// however, some funtcionts are linked each other and more complex which are tested in test2
void test2();
...
int rowsize(park* p){
   int cnt = 0;
   // since calloc is not allowed, 
   //i made a function which set all cells to '0' except valid carpark range
